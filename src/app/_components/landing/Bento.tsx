            ...
            <SlideWrapper delay={1}>
                <BentoGrid>
                    ...
                    <BentoCard
                        ...
                        background={
                            <FlickeringGrid
                                className="opacity-50 absolute inset-0 bg-gradient-to-tr from-emerald-500/5 to-sky-500/5"
                                squareSize={4}
                                gridGap={4}
                                flickerChance={0.1}
                                maxOpacity={0.1}
                    ...
                    <BentoCard
                        ...
                        background={
                            <DotPattern
                                className="absolute inset-0 h-full w-full dark:opacity-20 animate-spin-slow bg-gradient-to-tr from-violet-500/5 via-secondary/10 to-rose-500/10"
                                width={32}
                                height={32}
                                cx={16}
                                cy={16}
